...
export default function useProfileSearch(query, pageNumber, t) {
    ...
    axios({
      ...
      .then((res) => {
        setPosts((prevPosts) => {
          if(type=="created"){
            ...
            return [
              ...new Set([
                ...prevPosts,
                ...res.data.data.get_payout_posts.map((b) => b),
              ]),
            ];
          }
          else if(type=="voted"){
            ...
            return [
              ...new Set([
                ...prevPosts,
                ...res.data.data.get_blog_posts.map((b) => b),
              ]),
            ];
          }
          else if(type=="feed"){
            return [
              ...new Set([
                ...prevPosts,
                ...res.data.data.get_feed_posts.map((b) => b),
              ]),
            ];
          }
          else if(type=="commented"){
        ...
        if(type=="created"){
          ...
          setHasMore(res.data.data.get_blog_posts.length > 0);
        }
        else if(type=="feed"){
          setHasMore(res.data.data.get_feed_posts.length > 0);
        }
        else if(type=="commented"){
  ...
  return { visible, type, error, posts, hasMore, setType, setPosts };
}
