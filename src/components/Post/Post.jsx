...
const Post = ({ p, setposts }) => {
    ...
    let text = htmlToText.fromString(post.body, {
        wordwrap: 10
    });
        ...
        <div class="post-bar" key={post.permlink} style={{ display: displayPost }}>
            <div class="post-bar no-margin">
                ...
                <div class="job_descp">
                    ...
                    {json.image ? <p><img src={json.image[0]} alt="" /></p> : null}
                    <p>{text}... <a href={"/post/" + post.category + "/@" + post.author + "/" + post.permlink} target="_blank">view more</a></p>
                    <ul class="skill-tags">
